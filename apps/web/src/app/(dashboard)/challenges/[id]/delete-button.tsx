...
export function DeleteChallengeButton({ challengeId, isProcessing }: DeleteChallengeButtonProps) {
  ...
  async function onDelete() {
    const confirmed = await confirmAction({
      ...
      text: 'This challenge will be permanently deleted. This action cannot be undone.',
      confirmText: 'Delete',
      type: 'danger',
    })
    if (!confirmed) return
